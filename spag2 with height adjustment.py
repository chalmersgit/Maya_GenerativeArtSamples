...
for i in range(size):
    ...
    cmds.curve( p=[(0, 0, 0), (random.randint(endExtrudeA, endExtrudeB), height, random.randint(endExtrudeA, endExtrudeB)), (random.randint(endExtrudeA, endExtrudeB), height+heghtTaper1, random.randint(endExtrudeA, endExtrudeB)), (random.randint(endExtrudeA, endExtrudeB), height+heghtTaper2, random.randint(endExtrudeA, endExtrudeB))] )
